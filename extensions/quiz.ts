...
export default function quiz(pi: ExtensionAPI) {
	pi.registerTool({
		...
		promptGuidelines: [
			...
			"After an incorrect result, read the selected option and correct that specific misconception in one brief follow-up sentence. The prewritten quiz explanation cannot know which option the learner will pick; avoid repeating a full lesson.",
